...
import TemplateCreateUpdateView from "@/components/views/templates/create-update";
...
export default async function TemplateCreateUpdatePage({
  params,
  searchParams,
}: {
  ...
  const title = isCreate ? "Create Template" : "Update Template";
    ...
    <>
      <EBreadcrumb
        items={[
          ...
          {
            title: <Link href={route_paths.templates}>Templates</Link>,
          },
          {
