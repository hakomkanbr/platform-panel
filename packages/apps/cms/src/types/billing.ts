...
export interface InvoiceDto {
  ...
  totalAmount: number;
  currency: string;
  status: "Pending" | "Paid" | "Failed" | "Cancelled" | "Overdue" | "Refunded" | "Credit";
  invoiceType: "subscription" | "upgrade" | "downgrade" | "renewal" | "credit_note" | "manual";
...
export interface InvoiceLineItemDto {
  ...
  unitPrice: number;
  totalPrice: number;
  type: "prorated_charge" | "prorated_refund" | "full_charge" | "discount" | "tax" | "credit" | "fee_waiver";
}
