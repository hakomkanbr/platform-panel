  ...
  useEffect(() => {
    registerSaveHandler("seo", async () => {
      ...
      await updateTranslation.mutateAsync({
         ...
         shortDescription: product?.translations?.[0]?.shortDescription ?? product?.shortDescription ?? null,
         description: product?.translations?.[0]?.description ?? product?.description ?? null,
